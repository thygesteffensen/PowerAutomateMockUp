...
namespace Test.ActionTests
{
    ...
    public class ForEachActionExecutorTest
    {
        ...
        public async Task Test()
        {
            ...
            stateMock.Verify(x => x.AddItemHandler(It.IsAny<string>(), It.IsAny<IItemHandler>()), Times.Exactly(1));
            ...
            stateMock.Verify(x => x.AddItemHandler(It.IsAny<string>(), It.IsAny<IItemHandler>()), Times.Exactly(2));
            sdmMock.Verify(x => x.Push(It.IsAny<string>(), It.IsAny<IEnumerable<JProperty>>(),
                It.Is<ForEachActionExecutor>(actionExecutor =>
            ...
            stateMock.Verify(x => x.AddItemHandler(It.IsAny<string>(), It.IsAny<IItemHandler>()), Times.Exactly(3));
            sdmMock.Verify(x => x.Push(It.IsAny<string>(), It.IsAny<IEnumerable<JProperty>>(),
                It.Is<ForEachActionExecutor>(actionExecutor =>
